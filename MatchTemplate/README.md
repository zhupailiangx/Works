...
## 总结
（1）MatchTemplate 算子Linux比Windows性能差，是因为Windows使用了IPP优化<br>
（2）Windows exe安装，有ipp优化 <br>
（3）Linux sudo apt install libopencv-dev 安装没有ipp优化 <br>
（4）Linux 和Windows源码安装opencv WITH_IPP=ON 需要配置代理权限
